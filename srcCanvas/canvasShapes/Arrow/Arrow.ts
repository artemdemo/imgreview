...
class Arrow extends Shape implements IGeometricShape {
  ...
  private readonly props: TArrowProps;
  private readonly anchorsGroup: AnchorsGroup;

  // `substratePath` path used to receive mouse events.
  // It's useful for thin paths, when it's hard to "catch" them.
  private substratePath: Konva.Path | undefined;
  private visiblePath: Konva.Path | undefined;
  private arrowHead: ArrowHead | undefined;
