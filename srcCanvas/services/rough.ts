...
const drawToContext = (ctx: CanvasRenderingContext2D, drawing: OpSet, rule: CanvasFillRule = 'nonzero') => {
    ctx.beginPath();
...
const fillSketch = (ctx: CanvasRenderingContext2D, drawing: OpSet, o: ResolvedOptions) => {
