...
describe('OpenImageDialog', () => {
  ...
  it('should render', () => {
    ...
    const tree = renderer
      .create(<OpenImageDialog canvas={state.canvas} />)
      .toJSON();
  ...
  it('should handle click', () => {
    const wrapper = mount(<OpenImageDialog />);
  ...
  it('should read image', () => {
    const wrapper = mount(<OpenImageDialog addImage={() => {}} />);
    const instance = wrapper.instance();
    const file = {
      name: 'some-name.jpg',
    };
  ...
  it('should set an image', () => {
    ...
    const wrapper = mount(<OpenImageDialog addImage={addImageMock} />);
    const instance = wrapper.instance();
    const file = {
      name: 'some-name.jpg',
    };
