...
<Layout gap="10px 15px">
  ...
  <Cell span={6}>
    <ContentImage
      ...
      width={900}
      height={598}
      src="/imgreview/images/features-multiple-images.gif"
    />
  </Cell>
  <Cell span={6}>
    <ContentImage
      ...
      width={900}
      height={598}
      src="/imgreview/images/features-add-shape-arrow.gif"
    />
  </Cell>
  <Cell span={6}>
    <h3>Copy all</h3>
  ...
  <Cell span={6}>
    <ContentImage
      ...
      width={900}
      height={598}
      src="/imgreview/images/features-copy-all.gif"
    />
  </Cell>
  <Cell span={6}>
    <ContentImage
      ...
      width={900}
      height={598}
      src="/imgreview/images/features-sketchify.gif"
    />
  </Cell>
  <Cell span={6}>
    <h3>Add emotions</h3>
